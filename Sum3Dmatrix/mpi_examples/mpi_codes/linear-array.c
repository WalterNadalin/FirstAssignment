// We have a list of processors one after the other and each one of them is sending and receveing from a neighbour
// actually each processor is receveing from the previous one and sending to the next one
